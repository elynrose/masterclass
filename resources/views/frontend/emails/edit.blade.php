                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.emails.update", [$email->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subject" id="subject" value="{{ old('subject', $email->subject) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="body" id="body">{!! old('body', $email->body) !!}</textarea>
                            @if($errors->has('body'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('body') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ordering" id="ordering" value="{{ old('ordering', $email->ordering) }}" step="1" required>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.emails.storeCKEditorImages') }}', true);
