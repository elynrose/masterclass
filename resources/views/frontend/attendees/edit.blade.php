    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.attendees.update", [$attendee->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="from_email" id="from_email" value="{{ old('from_email', $attendee->from_email) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="from_website" id="from_website" value="{{ old('from_website', $attendee->from_website) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="attended_session" id="attended_session" value="{{ old('attended_session', $attendee->attended_session) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="received_follow_up_email" id="received_follow_up_email" value="{{ old('received_follow_up_email', $attendee->received_follow_up_email) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="viewed_follow_up" id="viewed_follow_up" value="{{ old('viewed_follow_up', $attendee->viewed_follow_up) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="watched_last_session" id="watched_last_session" value="{{ old('watched_last_session', $attendee->watched_last_session) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="invited_to_next_session" id="invited_to_next_session" value="{{ old('invited_to_next_session', $attendee->invited_to_next_session) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="viewed_next_session_email" id="viewed_next_session_email" value="{{ old('viewed_next_session_email', $attendee->viewed_next_session_email) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="signed_up_for_next_session" id="signed_up_for_next_session" value="{{ old('signed_up_for_next_session', $attendee->signed_up_for_next_session) }}" step="1">
