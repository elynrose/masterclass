                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sessions.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="topics" id="topics">{!! old('topics') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="course_details" id="course_details">{!! old('course_details') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="zoom_link" id="zoom_link" required>{{ old('zoom_link') }}</textarea>
