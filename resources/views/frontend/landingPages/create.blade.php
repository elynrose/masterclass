    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.landing-pages.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="register_label" id="register_label" value="{{ old('register_label', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="teacher_name" id="teacher_name" value="{{ old('teacher_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="stripe_code" id="stripe_code">{{ old('stripe_code') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="teacher_bio" id="teacher_bio">{!! old('teacher_bio') !!}</textarea>
