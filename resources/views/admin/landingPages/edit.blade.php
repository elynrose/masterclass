    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.landing-pages.update", [$landingPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $landingPage->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_title') ? 'is-invalid' : '' }}" type="text" name="sub_title" id="sub_title" value="{{ old('sub_title', $landingPage->sub_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('register_label') ? 'is-invalid' : '' }}" type="text" name="register_label" id="register_label" value="{{ old('register_label', $landingPage->register_label) }}" required>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('teacher_photo') ? 'is-invalid' : '' }}" id="teacher_photo-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('teacher_name') ? 'is-invalid' : '' }}" type="text" name="teacher_name" id="teacher_name" value="{{ old('teacher_name', $landingPage->teacher_name) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('stripe_code') ? 'is-invalid' : '' }}" name="stripe_code" id="stripe_code">{{ old('stripe_code', $landingPage->stripe_code) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('teacher_bio') ? 'is-invalid' : '' }}" name="teacher_bio" id="teacher_bio">{!! old('teacher_bio', $landingPage->teacher_bio) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primary_color') ? 'is-invalid' : '' }}" type="text" name="primary_color" id="primary_color" value="{{ old('primary_color', $landingPage->primary_color) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('secondary_color') ? 'is-invalid' : '' }}" type="text" name="secondary_color" id="secondary_color" value="{{ old('secondary_color', $landingPage->secondary_color) }}">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.landing-pages.storeCKEditorImages') }}', true);
