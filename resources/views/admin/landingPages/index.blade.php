...
@can('landing_page_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.landing-pages.create') }}">
                        ...
                        <tr data-entry-id="{{ $landingPage->id }}">
                            ...
                            <td>
                                @can('landing_page_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.landing-pages.show', $landingPage->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('landing_page_delete')
                                    <form action="{{ route('admin.landing-pages.destroy', $landingPage->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('landing_page_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.landing-pages.massDestroy') }}",
