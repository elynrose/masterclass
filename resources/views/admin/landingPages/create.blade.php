    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.landing-pages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('register_label') ? 'is-invalid' : '' }}" type="text" name="register_label" id="register_label" value="{{ old('register_label', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('teacher_name') ? 'is-invalid' : '' }}" type="text" name="teacher_name" id="teacher_name" value="{{ old('teacher_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('stripe_code') ? 'is-invalid' : '' }}" name="stripe_code" id="stripe_code">{{ old('stripe_code') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('teacher_bio') ? 'is-invalid' : '' }}" name="teacher_bio" id="teacher_bio">{!! old('teacher_bio') !!}</textarea>
