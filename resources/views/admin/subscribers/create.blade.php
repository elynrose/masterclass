    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.subscribers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('provided_phone') ? 'is-invalid' : '' }}" type="number" name="provided_phone" id="provided_phone" value="{{ old('provided_phone', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('signed_up') ? 'is-invalid' : '' }}" type="number" name="signed_up" id="signed_up" value="{{ old('signed_up', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('read_page_contents') ? 'is-invalid' : '' }}" type="number" name="read_page_contents" id="read_page_contents" value="{{ old('read_page_contents', '0') }}" step="1">
