    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sessions.update", [$session->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('excerpt') ? 'is-invalid' : '' }}" name="excerpt" id="excerpt">{!! old('excerpt', $session->excerpt) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('intro_video') ? 'is-invalid' : '' }}" id="intro_video-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('topics') ? 'is-invalid' : '' }}" name="topics" id="topics">{!! old('topics', $session->topics) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('course_details') ? 'is-invalid' : '' }}" name="course_details" id="course_details">{!! old('course_details', $session->course_details) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('zoom_link') ? 'is-invalid' : '' }}" name="zoom_link" id="zoom_link" required>{{ old('zoom_link', $session->zoom_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $session->date) }}" required>
                @if($errors->has('date'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time') ? 'is-invalid' : '' }}" type="text" name="time" id="time" value="{{ old('time', $session->time) }}" required>
                @if($errors->has('time'))
                    <div class="invalid-feedback">
                        {{ $errors->first('time') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('cadence') ? 'is-invalid' : '' }}" name="cadence" id="cadence" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration') ? 'is-invalid' : '' }}" type="number" name="duration" id="duration" value="{{ old('duration', $session->duration) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('next_session') ? 'is-invalid' : '' }}" name="next_session_id" id="next_session_id">
