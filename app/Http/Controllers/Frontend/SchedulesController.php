...
class SchedulesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.schedules.create', compact('sessions'));
    }
    ...
    public function store(StoreScheduleRequest $request)
    {
        ...
        return redirect()->route('frontend.schedules.index');
    }
    ...
    public function edit(Schedule $schedule)
    {
        ...
        return view('frontend.schedules.edit', compact('schedule', 'sessions'));
    }
