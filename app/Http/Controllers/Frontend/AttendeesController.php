...
class AttendeesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.attendees.index', compact('attendees'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.attendees.create', compact('sessions', 'users'));
    }
    ...
    public function store(StoreAttendeeRequest $request)
    {
        ...
        return redirect()->route('frontend.attendees.index');
    }
    ...
    public function edit(Attendee $attendee)
    {
        ...
        return view('frontend.attendees.edit', compact('attendee', 'sessions', 'users'));
    }
    ...
    public function show(Attendee $attendee)
    {
        ...
        return view('frontend.attendees.show', compact('attendee'));
    }
